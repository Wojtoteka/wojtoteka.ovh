...
(() => {
    ...
    const cheat = (async () => {
        ...
        Object.assign(gui.style, {
            top: Math.max(20, window.innerHeight / 2 - 300) + "px",
            left: Math.max(20, innerWidth / 2 - 450) + "px",
        });
        const variables = {
    "--highlight": "#8b5cf6",
    "--highlight2": "#a78bfa",
...
.controls,.gamemodesList,.guiContent,.guiTopBar,.sidebar,.sidebarShadow,.version{position:absolute}.sidebarShadow{inset:0;background:#000;opacity:0%;pointer-events:none;transition:.2s;z-index:9}.controls>div,.guiContent,.sidebar{background:var(--background2)}.sidebarShadow:has(~ .sidebar:hover){opacity:40%}.sidebar {
  top: 0;
  left: 0;
  height: 100%;
  width: 60px;
...
.sidebar:hover{width:220px;transition-delay:0s}.guiContent{inset:20px;left:80px;top:60px;z-index:1;padding-top:20px}.guiTopBar{z-index:1;top:0;left:60px;right:0;height:44px;background:var(--background2);border-bottom:2px solid var(--highlight)}.version{top:0;left:0;margin-inline:10px;color:var(--textColor2);font-size:.9em;letter-spacing:.5px;height:100%;display:flex;text-shadow:0 0 5px rgba(255,255,255,0.2)}.controls{top:0;right:0;display:grid;grid-template-columns:1fr 1fr 1fr;height:44px;width:150px;gap:2px;border:1px solid var(--background);z-index:2}.controls>div{display:grid;place-items:center;font-weight:100;color:var(--textColor);border:1px solid var(--highlight);transition:.2s}.controls>div:hover{background:var(--highlight);color:#fff}.closeControl{transition:.1s}.closeControl:hover{background:red;border-color:red}.gamemodesPage,.searchPage{position:absolute;inset:0;top:50px}.gamemodesList{display:grid;gap:0 30px;padding-inline:30px;margin-top:0;padding-top:15px;margin-bottom:0;grid-template-columns:1fr 1fr;overflow-y:scroll;inset:0;font-size:1.05em}.leaderboardPage,.logsPage{inset:10px;position:absolute}.pathText{position:absolute;top:58px;left:80px;right:20px;z-index:3;padding:10px 12px;height:auto;min-height:30px;font-size:1.1em;border-radius:8px;background:var(--background2);color:var(--textColor);border:1px solid var(--highlight)}.clearLogsButton,.refreshControl{z-index:5;place-items:center;cursor:pointer}.leaderboardPage{top:60px}.leaderboardList{list-style:none;margin:0;padding:20px 40px 10px;height:100%;overflow:scroll;font-size:1.5em}.logsPage{top:55px;background:#000d;border-radius:10px}.logMessages{list-style:none;margin:10px;padding:0;display:flex;flex-direction:column-reverse;overflow-y:scroll;word-wrap:break-word;position:absolute;inset:0}.clearLogsButton{position:absolute;top:8px;right:8px;width:40px;height:40px;display:grid;scale:-1 1 1;transition:.2s}.searchbarHolder{display:flex;outline:2px solid var(--highlight);margin:10px 20px;height:50px;font-size:2em;border-radius:10px}.searchbarInput{outline:0;border:none;background:0 0;color:var(--textColor);flex:1;font-size:.65em;font-family:Nunito;padding-inline:10px}.gamemode,.settingsPage>div{border-radius:2.5px;background:var(--background)}.searchbarButton{color:var(--textColor);font-size:.7em;aspect-ratio:1/1;height:50px;display:grid;place-items:center;cursor:pointer;transition:.2s}.searchbarButton:hover{color:var(--highlight)}.bigText,.bigTextContainer{height:50px;width:200px;font-family:Titan One}.searchResults{position:absolute;inset:0;top:45px;padding-inline:20px;overflow-y:scroll}.favoritesPage,.settingsPage{inset:0;top:50px;overflow-y:scroll;position:absolute}.noResult{margin:20px 10px;font-size:.85em;color:var(--textColor2)}.clearLogsButton:hover,.licenseMessage{font-size:1.25em}.favoritesPage{padding-block:10px;padding-inline:20px}.licenseMessage{font-weight:900;padding-inline:20px;margin-top:10px}.copyrightTag{font-size:.7em;font-weight:200;position:absolute;bottom:0;left:0;padding:5px 8px}.settingsPage{padding:10px;display:flex;flex-direction:column;gap:10px}.sidebarPaths{display:flex;flex-direction:column;width:220px}.bigTextContainer{display:flex;font-size:2em;margin-block:10px;transition:font-size .2s .1s,margin-block .2s .1s}.bigText{display:flex;align-items:center;justify-content:center}.refreshControl{position:absolute;top:60px;right:25px;width:40px;height:40px;display:grid}.gamemode{width:100%;height:220px;margin-bottom:30px;cursor:pointer;display:flex;justify-content:center;align-items:center;padding-top:10px;position:relative;overflow:hidden;padding-bottom:40px;transition:.4s}.contentPage,.gamemode>div{position:absolute;bottom:0}.gamemode:hover{box-shadow:0 0 10px var(--highlight);transition:.2s}.gamemode>img{width:85%;max-width:100%;max-height:100%}.gamemode>div{left:0;right:0;height:25px;background:var(--highlight);display:flex;justify-content:center;align-items:center;box-shadow:0 -5px 5px #0004;font-weight:800;font-size:1.1em;transition:.25s}.contentPage{inset-inline:0;top:50px}.cheatsList{display:flex;flex-direction:column;height:100%;overflow-y:scroll;padding-inline:10px}.cheatToggle,.cheatToggle>.toggleTrigger,.runCheat{height:48px;border-radius:10px}.cheatsList>div{display:grid;margin-bottom:10px;position:relative;background:var(--background);border-radius:2.5px}.cheatInfo,.cheatInputs,.cheatName,.cheatTop,.logMessage>span,.runCheat,.sidebarPath,.sidebarPath>i{display:flex}.cheatInfo{flex-direction:column;flex:1}.cheatName{font-size:1.5em;font-weight:700;color:var(--textColor)}.cheatDescription{font-size:.8em;margin-right:25px;color:var(--textColor2);opacity:0.9}.runCheat{--buttonColor:var(--highlight);width:20%;background:var(--buttonColor);margin-block:auto;cursor:pointer;align-items:center;justify-content:center;font-weight:800;transition:.5s;color:#fff!important}.runCheat:hover{box-shadow:0 0 10px 0 var(--buttonColor);transition:.3s}.runCheat:active{box-shadow:0 0 0 0 var(--buttonColor);transition:50ms}.cheatInputs{margin:5px 0 5px 5px;flex-direction:column;gap:5px}.searchResult,.standing{margin-bottom:10px;transition:.2s}.logMessage img,.standingBlook{margin-right:5px}.cheatInputs>div{display:flex;flex-direction:row;font-size:.95rem;color:var(--highlight);font-weight:700;align-items:center;min-height:44px}.cheatInputs>div>span{flex:1;text-shadow:0 0 8px var(--highlight)}.cheatToggle{width:20%;background:var(--highlight2);margin-block:auto;cursor:pointer;position:relative}.cheatToggle>.toggleTrigger{width:45px;position:absolute;top:0;left:0;background:var(--highlight);pointer-events:none;transition:left .2s,box-shadow .5s;z-index:1}.cheatToggle:hover>.toggleTrigger{box-shadow:0 0 10px 0 var(--highlight);transition:left .2s,box-shadow .2s}.toggleTrigger.active{left:calc(100% - 45px)}.toggleColor{position:absolute;inset:10px 20px;background:rgb(from var(--toggleOff) r g b / 25%);border-radius:2.5px;transition:.2s}.toggleTrigger.active+.toggleColor{background:rgb(from var(--toggleOn) r g b / 25%)}input[data-type],select[data-type]{width:20%;min-height:44px;outline:0;border:2px solid var(--highlight);box-sizing:border-box;background:var(--background2);color:var(--textColor);font-size:1em;padding-left:10px;font-family:Nunito;border-radius:8px;font-weight:800}.logo,.sidebarPath>i{width:60px;height:60px}select[data-type]{-webkit-appearance:none;-moz-appearance:none;text-indent:1px;text-overflow:''}input::placeholder{color:rgb(from var(--textColor) r g b / 50%)}input[data-type]::-webkit-inner-spin-button,input[data-type]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}input[data-type][type=number]{-moz-appearance:textfield}select[data-type] option{border-radius:0;background:var(--background);color:var(--textColor)}select[data-type]::-ms-expand{display:none}.sidebarPath{align-items:center;cursor:pointer;transition:.2s 0.1s;color:var(--textColor)}.searchResult:hover,.sidebarPath:hover{color:var(--highlight);text-shadow:0 0 5px var(--highlight)}.sidebarPath>i{justify-content:center;align-items:center;font-size:1.5em;color:var(--highlight)}.sidebarPath>span{padding-left:5px;text-shadow:0 0 5px rgba(255,255,255,0.3)}.sidebar:hover .sidebarPath{padding-left:20px;transition-delay:0s}.logo{left:0;transition:left .2s .1s;display:grid;place-items:center;min-width:50px;position:absolute}.sidebar:hover .logo{left:28px;transition:left .2s}.bigText{margin-top:-150px;transition:margin-top .1s}.sidebar:hover .bigText{margin-top:0;transition:margin-top .4s 0.1s}.sidebar:hover .bigTextContainer{font-size:2.5em;margin-block:20px;transition:font-size .2s,margin-block .2s}
.bigText {
  text-shadow: 0 0 15px var(--highlight), 0 0 25px var(--highlight2);
  animation: glowPulse 2s ease-in-out infinite alternate;
  color: var(--highlight);
}
@keyframes glowPulse {
  from { text-shadow: 0 0 15px var(--highlight); }
  to { text-shadow: 0 0 30px var(--highlight2), 0 0 45px var(--highlight); }
}
.pathPage:hover{text-decoration:underline}.warning{color:var(--highlight2);font-size:.85em}.searchResult{cursor:pointer;color:var(--textColor)}.searchResultName{font-weight:800;color:var(--textColor)}.searchResultDescription{font-size:.8em;color:var(--textColor2)}.searchResultSeparator{font-size:1.5em;font-weight:800;margin-block:10px;cursor:pointer;transition:.2s;border-bottom:2px solid #fff;padding-inline:5px;filter:drop-shadow(0px 0px 0px var(--highlight))}.searchResultSeparator:hover{color:var(--highlight);border-bottom:2px solid var(--highlight);filter:drop-shadow(0px 0px 2.5px var(--highlight))}.toggleCheat{--buttonColor:var(--toggleOff)}.toggleCheat.active{--buttonColor:var(--toggleOn)}.logMessage img{height:1em;align-self:center}.standing{display:flex;font-weight:800;align-items:center;position:relative;padding:5px 10px 5px 50px;border-radius:2.5px;background:var(--highlight2)}.standing:before{content:attr(data-place) ".";margin-right:10px}.standing::after{content:attr(data-value);flex:1;text-align:right;font-weight:100}.standing:hover{background:var(--standingColor);box-shadow:0 0 7.5px var(--standingColor)}.standingBlook{height:1.25em;align-self:center;position:absolute;left:10px}.favoriteButton,.favoriteButton>i{transition:.2s;display:grid;place-items:center;width:32px;height:32px}.favoriteButton{font-size:.8em;padding-left:5px;cursor:pointer}.favoriteButton:hover{color:#ff0}.favoriteButton>i{position:absolute;scale:0;transform-origin:50% 55%}.favoriteButton>i.filled{scale:1}.pathPage{cursor:pointer;color:var(--highlight)}[data-favorited=false],[data-favorites="0"]{display:none}
...
setTimeout(roundGamemodeBoxes, 50);
        ...
        version.innerText = "Z-Client - Wojtoteka - " +  versionName;
...
moveControl.innerHTML = `<i class="zclient-i zclient-move"></i>`;
...
function setMinIcon(min) {
  minimizeControl.innerHTML =
    `<i class="zclient-i ${min ? "zclient-min" : "zclient-full"}"></i>`;
}
setMinIcon(true);
...
minimizeControl.onclick = () => {
  ...
  gui.animate(
    [
      { width: hidden ? "150px" : "95vw", height: hidden ? "46px" : "90vh", left: gui.style.left },
      { width: hidden ? "95vw" : "150px", height: hidden ? "90vh" : "46px",
        left: `${parseInt(gui.style.left) + (hidden ? -750 : 750)}px` }
    ],
    { duration: 200, easing: "ease" }
  );

  gui.style.width = hidden ? "95vw" : "150px";
  gui.style.height = hidden ? "90vh" : "46px";
  ...
  gui.style.left = `${parseInt(gui.style.left) + (hidden ? -750 : 750)}px`;
...
closeControl.innerHTML = `<i class="zclient-i zclient-close"></i>`;
closeControl.onclick = () => {
    if (confirm('Czy na pewno chcesz zamknąć Z-Client?')) {
        gui.remove();
    }
};
...
const PERSIST_KEY = "zclient_state_v1";
const SHIFT = 750;
...
(async function restoreGUI() {
    ...
    if (s.left || s.top) {
        gui.style.width = "95vw";
        gui.style.height = "90vh";
...
document.addEventListener("pointerup", () => setTimeout(saveGUIState, 30));
            ...
            fetchBlooks() {
                return (
                    ...
                    new Promise((r) => {
                        ...
                        x.type = "module";
                        x.src = document.querySelector("script[src*='ac.blooket.com']").src + "?" + Date.now();
                                ...
                                case "factory":
                                    for (const player in added) {
                                        if ((addedPlayer = added[player]).g) Logs.addAlert(player, `activated the ${Logs.gamemodeData.factory.glitches[addedPlayer.g]} glitch!`);
                                            ...
                                            const [amount, synergy] = addedPlayer.x.split("-");
        ...
        const cheats = {
            global: {
                ...
                cheats: [
                    {
                        name: "Auto Answer",
                        description: "Włącza automatyczne odpowiadanie",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    },
                    {
                        ...
                        description: "Włącza podświetlanie odpowiedzi",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    },
                    {
                        ...
                        description: "Włącza subtelne podświetlanie odpowiedzi",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
            ...
            description: "Zamraża tablicę wyników na ekranie hosta",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
                ...
                if (this.enabled)
                    ...
                    name: "Anti Kick",
        description: "Zapobiega wyrzuceniu przez hosta, choć cheaty przestaną działać i nie możesz wygrać",
        type: "toggle",
        enabled: false,
        data: null,
        run: function () {
            ...
            if (!this.enabled) {
                ...
                this.data = null;
                        ...
                        description: "Odpowiada poprawnie lub błędnie w zależności od docelowej oceny (Wyłącz i włącz ponownie aby zaktualizować cel)",
                        inputs: [
                            {
                                name: "Target Grade",
                                type: "number",
                    ...
                    {
                        name: "Auto Answer",
                        description: "Automatycznie klika poprawną odpowiedź",
                        run: function () {
                            const stateNode = getStateNode();
                            const Question = stateNode.state.question || stateNode.props.client.question;
                            if (stateNode.state.question.qType != "typing") {
                    ...
                    {
                        name: "Highlight Answers",
                        description: "Koloruje odpowiedzi na czerwono lub zielono podświetlając poprawne",
                        run: function () {
                            const stateNode = getStateNode();
                            const Question = stateNode.state.question || stateNode.props.client.question;
                            let ind = 0;
            ...
            description: "Symuluje odblokowanie określonego blooka",
            inputs: [{
            ...
            name: "Simulate Pack",
            description: "Symuluje odblokowywanie paczki",
            inputs: [{
                name: "Pack",
                type: "options",
            ...
            run: async (packName) => {
                ...
                setTimeout(() => stateNode.setState({
                    canOpen: !0
                        ...
                        description: "Otwiera pudełko określoną ilość razy",
                        inputs: [
                            {
                                name: "Box",
                                type: "options",
            ...
            name: "Use any Banner",
            description: "Odblokowuje wszystkie bannery",
            inputs: [{
                name: "Banner",
                type: "options",
            ...
            run: function(e) {
                ...
                document.head.appendChild(t),
                    ...
                    a().stateNode.props.liveGameController.setVal({
                        ...
                        description: "Zmienia twojego blooka",
                        inputs: [
                            {
                                name: "Blook (case sensitive)",
                                type: "string",
                    ...
                    {
                        name: "Pin Guesser",
description: "Brute force kombinacje istniejących pinów. Działa tylko z wyłączonym CSP, musisz spamować aby znaleźć działający pin.",
run: function() {
    if (!window.location.href.includes("play.blooket.com")) alert("This cheat only works on play.blooket.com, opening a new tab."), window.open("https://play.blooket.com/");
    {
        ...
        !function r() {
            ...
            fetch(`https://fb.blooket.com/c/firebase/id?id=${i}`, {
                ...
                if (n.success === true) {
                    console.log("Game found:", i);
                    a.innerHTML = "Game Found";
                    o().setState({
                        client: {
                            hostId: i.toString()
                        }
                    ...
                    console.log("No game found for:", i);
                    o().setState({
                        client: {
                            hostId: i.toString()
                        }
            ...
            description: "Pozwala więcej graczom dołączyć jeśli gra jest pełna",
            run: async () => {
                let i = document.createElement('iframe');
                document.body.append(i);
                const alert = i.contentWindow.alert.bind(window);
                ...
                alert(`Freed slots: ${freed}`);
                        ...
                        description: "Zdobywa maksymalne dzienne tokeny i xp",
                        run: async function () {
                            if (!window.location.href.includes("play.blooket.com")) alert("This cheat only works on play.blooket.com, opening a new tab."), window.open("https://play.blooket.com/");
                            else {
                                const gameId = [
                    ...
                    {
                        name: "Blooket Bot",
            description: "Otwiera Blooket Bota",
            run: function() {
            ...
            description: "Otwiera Stream Findera",
            run: function() {
                function getGameCode() {
                    const appDiv = document.querySelector('#app>div>div');
                    if (appDiv) {
               ...
               name: "Crash Game",
            description: "Crashuje grę hosta",
            run: function() {
                var e = Object.values(function e(t = document.querySelector("#app")) {
                        return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                    }
                ...
                e.props.liveGameController.setVal({
                    ...
                    val: "Crashed"
                        ...
                        name: "Use Any Blook",
                        description: "Pozwala grać jako dowolny blook",
                        run: function () {
                    ...
                    },
                    {
                        ...
                        description: "Ustawia każdą odpowiedź jako poprawną",
                        run: function () {
                            const stateNode = getStateNode();
            ...
            description: "Usuwa wszystkie zajęte blooki, pozwalając użyć dowolnego zajętego blooka. Działa tylko w lobby.",
            run: function() {
                const stateNode = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                stateNode.setState({
                    takenBlooks: {
    ...
    description: "Wyrzuca wszystkich graczy z twojej gry.",
    run: function() {
        (async function() {
            ...
            description: "Sprawia że możesz hostować na telefonie",
            run: function() {
                (function() {
            ...
            description: "Usuwa limit czasu hosta",
            run: function() {
                (() => {
            ...
            name: "Freeze Timer",
            description: "Zatrzymuje timer hosta w grze",
            run: function() {
                (() => {
                    const {
                        stateNode
                    ...
                    stateNode.timerInterval = setInterval(function() {
                        ...
                        name: "Subtle Highlight Answers",
                        description: "Usuwa cień z poprawnych odpowiedzi",
                        run: function () {
                            const stateNode = getStateNode();
                            const Question = stateNode.state.question || stateNode.props.client.question;
                            let ind = 0;
                    ...
                    },
                    {
                        ...
                        description: "Pozwala wpisać własną nazwę",
                        run: function () {
            ...
            description: "Zmień wybrany tryb gry na stronie ustawień hosta",
            inputs: [{
                name: "Gamemode",
                type: "options",
                options: ["Racing", "Classic", "Factory", "Cafe", "Defense2", "Defense", "Royale", "Gold", "Candy", "Brawl", "Hack", "Fish", "Dino", "Toy", "Rush"]
            }],
            run: function(e) {
                ...
                a.setState({
                    settings: {
                        ...
                        description: "Sprzedaj wszystkie duplikaty blooków zostawiając po 1 z każdego",
                        run: async function () {
...
extras: {
  ...
  cheats: [
    {
       name: "Remove CSP and Bypass CORS",
            description: "Usuwa Content Security Policy i omija ograniczenia Cross-Origin Resource Sharing na stronie.",
            type: "toggle",
            run: function() {
                function REMOVE_CSP() {
                    ...
                    for (let i = metaTags.length - 1; i >= 0; i--) {
                        if (metaTags[i].getAttribute("http-equiv") === "Content-Security-Policy" ||
                            metaTags[i].getAttribute("http-equiv") === "S-Content-Security-Policy" ||
                            metaTags[i].getAttribute("http-equiv") === "S-WebKit-CSP") {
                    ...
                    if (window.XMLHttpRequest) {
                        ...
                        XMLHttpRequest.prototype.open = function(method, url) {
                            this.setRequestHeader("Content-Security-Policy", ""); 
                            this.setRequestHeader("S-Content-Security-Policy", "");
                            return originalOpen.apply(this, arguments);
                        };
                    }
                }

                function BYPASS_CORS() {
                    if (window.XMLHttpRequest) {
                        const originalOpen = XMLHttpRequest.prototype.open;
                        XMLHttpRequest.prototype.open = function(method, url) {
                            ...
                            this.setRequestHeader("Access-Control-Allow-Headers", "Content-Type, Authorization, S-Requested-With");
                            return originalOpen.apply(this, arguments);
                        };
                        ...
                        window.fetch = function(url, options = {}) {
                            ...
                            options.headers["Access-Control-Allow-Headers"] = "Content-Type, Authorization, S-Requested-With";
                            return originalFetch(url, options);
                        };
                    }
                }

                function DISABLE_WEB_SECURITY() {
                    Object.defineProperty(window, "localStorage", { get: function() { return window.localStorage; }, configurable: true });
                    Object.defineProperty(window, "sessionStorage", { get: function() { return window.sessionStorage; }, configurable: true });
                }
      ...
      description: "Przełącza między odwróceniem a przywróceniem kolorów na stronie",
      run: function () {
    ...
    },
    {
      name: "Toggle Dark Mode",
            description: "Przełącza tryb ciemny",
            run: function() {
            ...
            name: "3D Page",
            description: "Sprawia że strona jest 3D",
            run: function() {
                var e = {
            ...
            name: "Auto Clicker",
            description: "Automatycznie klika za ciebie. Naciśnij S aby przełączyć.",
            inputs: [{
                name: "Click Delay",
                type: "number"
            }],
            ...
            name: "Tab Cloaker",
            description: "Zmienia ikone i nazwę karty",
            inputs: [{
                name: "Icon URL",
                type: "text",
            }, {
  ...
  name: "Grayscale Mode",
  description: "Zmienia stronę na skalę szarości",
  run: function () {
    const html = document.documentElement;
    html.style.filter =
...
{
  name: "Sepia Mode",
  description: "Nakłada filtr sepii",
  run: function () {
    const html = document.documentElement;
    html.style.filter =
...
{
  name: "High Contrast",
  description: "Zwiększa kontrast dla lepszej czytelności",
  run: function () {
    const html = document.documentElement;
    html.style.filter =
...
{
  name: "Soft Blur",
  description: "Nakłada subtelne rozmycie",
  run: function () {
    const html = document.documentElement;
    html.style.filter =
...
{
  name: "Pastel Theme",
  description: "Miękka pastelowa paleta kolorów",
  run: function () {
...

{
  ...
  description: "Płynne cyklowanie kolorów",
  run: function () {
    if (window._rainbow) {
...
{
  name: "Rounded UI",
  description: "Ekstra zaokrąglone rogi",
  run: function () {
...
{
  name: "Outline UI",
  description: "Obramowuje elementy UI",
  run: function () {
...
{
  name: "Flat UI",
  description: "Usuwa cienie dla płaskiego wyglądu",
  run: function () {
...
{
  name: "Wobbly UI",
  description: "UI delikatnie się chwieje",
  run: function () {
...
{
  name: "Floating UI",
  description: "UI delikatnie unosi się w górę i w dół",
  run: function () {
...
{
  name: "Tiny UI",
  description: "Nieznacznie zmniejsza UI",
  run: function () {
    const html = document.documentElement;
...
{
  name: "Mirror Page",
  description: "Odbija stronę poziomo",
  run: function () {
    const html = document.documentElement;
...

{
  ...
  description: "Przełącza czarne obramowania na wszystkich elementach strony",
  run: function () {
  ...
  description: "Przełącza czerwone obramowania na wszystkich elementach strony",
  run: function () {
  ...
  description: "Subtelne trzęsienie ekranu",
  run: function () {
...
{
  name: "Jello UI",
  description: "Elementy UI chwiają się jak galaretka",
  run: function () {
...
{
  name: "Rotate Page",
  description: "Obraca całą stronę powoli",
  run: function () {
    const html = document.documentElement;
...
{
  name: "Scale Up Page",
  description: "Nieznacznie powiększa stronę",
  run: function () {
    const html = document.documentElement;
...
{
  name: "Spin Slowly",
  description: "Strona obraca się non-stop",
  run: function () {
    if (window._spin) {
...

{
  ...
  description: "Obraca stronę do góry nogami",
  run: function () {
    const html = document.documentElement;
...
{
  name: "Shake UI",
  description: "Elementy UI lekko się trzęsą",
  run: function () {
...

{
  ...
  description: "UI przerzuca się w lewo i prawo wielokrotnie",
  run: function () {
    if (window._flipH) {
...
{
  name: "Glow UI Pulse",
  description: "Elementy UI świecą i pulsują delikatnie",
  run: function () {
...
{
  name: "UI Zoom Pulse",
  description: "Elementy UI pulsują większe i mniejsze",
  run: function () {
...

{
  ...
  name: "Flip Random UI",
  description: "Elementy UI przerzucają się losowo. To zepsuje GUI, będziesz musiał przeładować.",
  run: function () {
    if (window._flipUI) {
...
{
  name: "Tilted Page",
  description: "Strona przechyla się w lewo i prawo powoli",
  run: function () {
    if (window._tiltPage) {
...

{
  ...
  description: "Strona obraca się powoli o 360 stopni",
  run: function () {
    if (window._pageFlip) {
  ...
  description: "Zmienia kursor myszy na celownik",
  run: function () {
...
{
  name: "Cursor: Pointer",
  description: "Zmienia kursor myszy na wskaźnik",
  run: function () {
...
{
  name: "Cursor: Grab",
  description: "Zmienia kursor myszy na chwytanie",
  run: function () {
...
{
  name: "Cursor: Move",
  description: "Zmienia kursor myszy na przesuwanie",
  run: function () {
...
{
  name: "Cursor: Wait",
  description: "Zmienia kursor myszy na oczekiwanie",
  run: function () {
...
{
  name: "Cursor: Help",
  description: "Zmienia kursor myszy na pomoc",
  run: function () {
...
{
  name: "Cursor: Text",
  description: "Zmienia kursor myszy na tekst (I-beam)",
  run: function () {
...
},
{
  ...
  description: "Zmienia kursor myszy na postęp",
  run: function () {
...
},
{
  ...
  description: "Zmienia kursor myszy na niedozwolone",
  run: function () {
...
{
  name: "Cursor: Alias",
  description: "Zmienia kursor myszy na alias",
  run: function () {
  ...
  description: "Ekstremalnie pogrubiony tekst",
  run: function () {
...

{
  ...
  description: "Nieznacznie zwiększa rozmiar tekstu dla lepszej czytelności",
  run: function () {
...
{
  name: "Outline Text",
  description: "Dodaje mocne obramowanie do tekstu dla widoczności",
  run: function () {
...
{
  name: "Shadowed Text",
  description: "Dodaje widoczny cień za tekstem dla głębi",
  run: function () {
...
{
  name: "Rainbow Text",
  description: "Tekst cyklicznie zmienia kolory tęczy",
  run: function () {
  ...
  name: "Reset Visuals",
  description: "Resetuje wszystkie zmiany wizualne",
  run: function () {
    document.documentElement.style.filter="";
    document.documentElement.style.transform="";
    ...
    clearInterval(window._rainbow);
    window._rainbow=null;
    document.querySelectorAll("style[id]").forEach(s=>x.remove());
    ...
    document.removeEventListener("mousemove",window._cursorGlowFn);
      ...
      description: "Przełącza rozmiar czcionki GUI między normalnym a nieco mniejszym.",
      run: function () {
          ...
          console.warn("GUI element not found for Toggle Small Font");
            ...
            gold: {
                ...
                cheats: [
                    {
                        name: "Always Triple",
                        description: "Zawsze otrzymuj potrójne złoto",
                        type: "toggle",
                        enabled: false,
            ...
            description: "Zawsze otrzymuj pięciokrotne złoto",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
                ...
                e._choosePrize ||= e.choosePrize,
                    this.enabled ? (this.enabled = !1, clearInterval(this.data), this.data = null, e.choosePrize = e._choosePrize || e.choosePrize) : (this.enabled = !0, this.data = setInterval(() => {
                        ...
                        name: "Auto Choose",
                        description: "Automatycznie wybiera opcję która da ci najwięcej złota",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    {
                        name: "Chest ESP",
                        description: "Pokazuje co da ci każda skrzynia",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    },
                    {
                        ...
                        description: "Usuwa szansę na otrzymanie Straty 25%, Straty 50% i Nic",
                        run: function () {
            ...
            description: "Sprawia że okienko alertu jest wypełnione tekstem",
            inputs: [{
                name: "Text",
                type: "text"
            }],
            run: function(userInput) {
                ...
                setValForPlayer();
                        ...
                        description: "Ustawia złoto gracza na 0",
                        inputs: [
                            {
                                name: "Player",
                                type: "options",
                    ...
                    {
                        name: "Set Gold",
                        description: "Ustawia ilość złota",
                        inputs: [
                            {
                                name: "Gold",
                                type: "number",
                    ...
                    },
                    {
                        ...
                        description: "Ustawia złoto innego gracza",
                        inputs: [
                            {
                                name: "Player",
                                type: "options",
            ...
            description: "Ustawia złoto wszystkich innych na 0",
            run: function() {
                var e = document.createElement("iframe");
                document.body.append(e),
                    window.alert = e.contentWindow.alert.bind(window),
            ...
            description: "Przełącza straszny motyw dla Gold Quest",
            run: function() {
                (() => {
                    const sn = Object.values(document.querySelector('#app>div>div'))[1].children[0]._owner.stateNode;
            ...
            name: "Send Ad Text",
            description: "Wysyła mnóstwo tekstu do innego gracza (To nadpisze twojego blooka!)",
            inputs: [{
                name: "Player",
                type: "options",
                options() {
    ...
    description: "Crashuje grę hosta dla Gold Quest",
    inputs: [],
    run: async function () {
        ...
        setv(["g/t", "t"]);
                        ...
                        name: "Swap Gold",
                        description: "Zamienia złoto zkimś",
                        inputs: [
                            {
                                name: "Player",
                                type: "options",
            ...
            hack: {
                ...
                cheats: [
                    {
                        name: "Choice ESP",
                        description: "Pokazuje co da ci każdy wybór",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    },
                    {
                        ...
                        name: "Password ESP",
                        description: "Podświetla poprawne hasło",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
            ...
            description: "Sprawia że cały ekran jest wypełniony tekstem",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
            ...
            name: "Always Quintuple",
            description: "Zawsze otrzymuj pięciokrotną krypto",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
                this.enabled ? (this.enabled = !1, clearInterval(this.data), this.data = null) : (this.enabled = !0, this.data = setInterval(() => Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode.setState({
                    choices: [{
                        ...
                        name: "Always Triple",
                        description: "Zawsze otrzymuj potrójną krypto",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    {
                        name: "Always Hack",
            description: "Zawsze otrzymuj hack",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
            ...
            name: "Crash Password",
            description: "Crashuje innych graczy gdy próbują cię zhackować",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
            ...
            description: "Zamraża innych graczy gdy próbują cię zhackować *JEŚLI WŁĄCZONE BĘDZIE STRASZNIE LAGOWAĆ*",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
                ...
                if (this.enabled) {
                    ...
                    this.data = setInterval(lagFunction, 25);
                        ...
                        name: "Auto Guess",
                        description: "Automatycznie odgaduje poprawne hasło",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    {
                        name: "Remove Hack",
                        description: "Usuwa atakujący hack",
                        run: function () {
    ...
    description: "Pokazuje hasło + krypto dla każdego gracza w Crypto Hack",
    type: "button",
    run: function () {
    ...
    run: async function (player, text) {
        ...
        t2.liveGameController.setVal({
            ...
            description: "Crashuje grę hosta dla Crypto Hack",
            run: function() {
                ...
                setv(['cr/t', 't']);
                        ...
                        name: "Set Password",
                        description: "Ustawia hasło hackowania",
                        inputs: [
                            {
                    ...
                    },
                    {
                        ...
                        description: "Kradnie całą krypto kogoś",
                        inputs: [
                            {
                                name: "Player",
                                type: "options",
                ...
                cheats: [
                    {
                        ...
                        description: "Usuwa rozproszenia",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
            ...
            description: "Frenzy tylko dla ciebie",
            type: "toggle",
            enabled: !1,
            run: function() {
                ...
                if (this.enabled) {
                    ...
                    componentInstance.setState({
                        ...
                        name: "Frenzy",
                        description: "Ustawia wszystkich w tryb frenzy",
                        run: function () {
                            let stateNode = getStateNode();
                            stateNode.props.liveGameController.setVal({
                                path: `c/${stateNode.props.client.name}`,
                    ...
                    },
                    {
                        ...
                        description: "Wysyła rozproszenie do wszystkich",
                        inputs: [
                            {
                                name: "Distraction",
                                type: "options",
                    ...
                    {
name: "Set Next Fish",
            description: "Ustawia następną rybę do złapania",
            inputs: [{
                name: "Fish",
                type: "options",
            ...
            run: function(e) {
                ...
                window.functionSet = !0,
                    ...
                    (e)
                        ...
                        name: "Set Lure",
                        description: "Ustawia przyętę na ryby (zakres 1 - 5)",
                        inputs: [
                            {
                                name: "Lure (1 - 5)",
                                type: "number",
                ...
                cheats: [
                    {
                        ...
                        description: "Sprawia że wszystkie postawione wieże są przepotężne",
                        run: function () {
                    ...
                    {
                        name: "Kill Enemies",
                        description: "Zabija wszystkich przeciwników",
                        run: function () {
                            let stateNode = getStateNode();
                    ...
                    {
                        name: "Set Health",
                        description: "Ustawia ilość zdrowia którą masz",
                        inputs: [
                            {
                                name: "Health",
                                type: "number",
                    ...
                    {
                        name: "Set Round",
                        description: "Ustawia aktualną rundę",
                        inputs: [
                            {
                                name: "Round",
                                type: "number",
                ...
                cheats: [
                    {
                        ...
                        description: "Podwaja wartość spadającego XP z przeciwników",
                        run: function () {
                    ...
                    },
                    {
                        ...
                        description: "Sprawia że przeciwnicy poruszają się 2x wolniej",
                        run: function () {
                            const colliders = getStateNode().game.current.config.sceneConfig.physics.world.colliders._active.filter((x) => x.callbackContext?.toString?.()?.includes?.("dmgCd"));
                            for (let i = 0; i < colliders.length; i++) {
                                const enemies = colliders[i].object2;
                    ...
                    {
                        name: "Instant Kill",
                        description: "Ustawia zdrowie wszystkich przeciwników na 1",
                        run: function () {
                            const colliders = getStateNode().game.current.config.sceneConfig.physics.world.colliders._active.filter((x) => x.callbackContext?.toString?.()?.includes?.("dmgCd"));
                            for (let i = 0; i < colliders.length; i++) {
                                const enemies = colliders[i].object2;
                    ...
                    {
                        name: "Invincibility",
                        description: "Sprawia że jesteś niezniszczalny",
                        run: function () {
                    ...
                    {
                        name: "Kill Enemies",
                        description: "Zabija wszystkich obecnych przeciwników",
                        run: function () {
                    ...
                    {
                        name: "Magnet",
                        description: "Przyciąga całe xp do ciebie",
                        run: function () {
                            getStateNode()
                    ...
                    },
                    {
                        ...
                        description: "Maksymalizuje wszystkie twoje obecne umiejętności",
                        run: function () {
                            const stateNode = getStateNode();
                    ...
                    {
                        name: "Next Level",
                        description: "Pomija do następnego poziomu",
                        run: function () {
                            let stateNode = getStateNode();
                    ...
                    },
                    {
                        ...
                        description: "Usuwa wszystkie skały i przeszkody",
                        run: function () {
                    ...
                    {
                        name: "Reset Health",
                        description: "Resetuje zdrowie i daje niezniszczalność na 3 sekundy",
                        run: function () {
            ...
            dino: {
                ...
                cheats: [
                    {
                        name: "Auto Choose",
                        description: "Automatycznie wybiera najlepszy kamień podczas wykopywania",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        rand(e, t) {
                    ...
                    {
                        name: "Rock ESP",
                        description: "Pokazuje co jest pod kamieniami",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: (() => {
                    ...
                    {
                        name: "Set Fossils",
                        description: "Ustawia ilość kopalń które masz",
                        inputs: [
                            {
                                name: "Fossils",
                                type: "number",
                    ...
                    {
                        name: "Set Multiplier",
                        description: "Ustawia mnożnik kopalin",
                        inputs: [
                            {
                                name: "Multiplier",
                                type: "number",
                    ...
                    {
                        name: "Stop Cheating",
                        description: "Cofa oszukiwanie aby nie można cię złapać",
                        run: function () {
                            let stateNode = getStateNode();
            ...
            royale: {
                ...
                cheats: [
                    ...
                    {
                        name: "Auto Answer",
                        description: "Wybiera poprawną odpowiedź za ciebie",
                        run: function () {
                            let stateNode = getStateNode();
                            stateNode?.onAnswer?.(true, stateNode.props.client.question.correctAnswers[0]);
                        },
            ...
            defense: {
                ...
                cheats: [
                    ...
                    {
                        name: "Remove Enemies",
                        description: "Usuwa wszystkich przeciwników",
                        run: function () {
                            let stateNode = getStateNode();
                    ...
                    {
                        name: "Remove Obstacles",
                        description: "Pozwala stawiać wieże wszędzie",
                        run: function () {
                            let stateNode = getStateNode();
                    ...
                    {
                        name: "Set Tokens",
                        description: "Ustawia ilość tokenów które masz",
                        inputs: [
                            {
                                name: "Tokens",
                                type: "number",
            ...
            cafe: {
                ...
                cheats: [
                    {
                        name: "Max Items",
                        description: "Maksymalizuje przedmioty w sklepie (Używalne tylko w sklepie)",
                        run: function () {
                    ...
                    },
                    {
                        ...
                        description: "Pomija obecnych klientów (Nie używalne w sklepie)",
                        run: function () {
                            const stateNode = getStateNode();
                    ...
                    },
                    {
                        ...
                        description: "Resetuje użyte umiejętności w sklepie (Używalne tylko w sklepie)",
                        run: function () {
                            if (window.location.pathname !== "/cafe/shop") alert("This can only be run in the shop");
                            else {
                                const stateNode = getStateNode();
                    ...
                    {
                        name: "Set Cash",
                        description: "Ustawia gotówkę cafe",
                        inputs: [
                            {
                                name: "Amount",
                                type: "number",
                    ...
                    },
                    {
                        ...
                        name: "Tax Player",
            description: "Sprawia że gracz płaci podatek",
            inputs: [{
                name: "Player's Name",
                type: "text"
            }],
            ...
            name: "Attack Player",
            description: "Wysyła graczowi inspekcję sanitarną",
            inputs: [{
                name: "Player's Name",
                type: "text"
            }],
            ...
            description: "Atakuje gracza aby gra stała się niegrawalna",
            inputs: [{
                name: "Player",
                type: "options",
                options() {
            ...
            run: function(name) {
                if (this.enabled) {
                    ...
                    this.data = setInterval(spamAction, 50);
                        ...
                        name: "Stock Food",
                        description: "Całe jedzenie do 99 (Nie używalne w sklepie)",
                        run: function () {
            ...
            factory: {
                ...
                cheats: [
                    ...
                    {
                        name: "Free Upgrades",
                        description: "Ustawia ceny ulepszeń na 0 dla wszystkich obecnych blooków",
                        run: function () {
                    ...
                    {
                        name: "Max Blooks",
                        description: "Maksymalizuje poziomy wszystkich twoich blooków",
                        run: function () {
                    ...
                    },
                    {
                        ...
                        description: "Usuwa wszystkie glitche przeciwników",
                        run: function () {
                            let stateNode = getStateNode();
                            stateNode.setState({
                                bits: 0,
                    ...
                    {
                        name: "Send Glitch",
                        description: "Wysyła glitch do wszystkich innych grających",
                        inputs: [
                            {
                                name: "Glitch",
                                type: "options",
                    ...
                    },
                    {
                        ...
                        description: "Ustawia wszystkie twoje blooki na zmaksymalizowane Mega Boty",
                        run: function () {
                    ...
                    {
                        name: "Set Cash",
                        description: "Ustawia ilość gotówki którą masz",
                        inputs: [
                            {
                                name: "Cash",
                                type: "number",
            ...
            racing: {
                ...
                cheats: [
                    {
                        name: "Instant Win",
                        description: "Natychmiastowo wygrywa wyścig",
                        run: function () {
                            const stateNode = getStateNode();
                    ...
                    {
                        name: "Set Questions",
                        description: "Ustawia liczbę pozostałych pytań",
                        inputs: [
                            {
                                name: "Questions",
                                type: "number",
            ...
            rush: {
                ...
                cheats: [
                    {
                        name: "Set Blooks",
                        description: "Ustawia ilość blooków twoją lub twojej drużyny",
                        inputs: [
                            {
                                name: "Blooks",
                                type: "number",
                    ...
                    {
                        name: "Set Defense",
                        description: "Ustawia ilość obrony twoją lub twojej drużyny (Maks 4)",
                        inputs: [
                            {
                                name: "Defense (max 4)",
                                type: "number",
            ...
            tower: {
                ...
                cheats: [
                    {
                        name: "Fill Deck",
                        description: "Wypełnia twoją talię każdą zmaksymalizowaną kartą i artefaktem (Działa tylko na stronie wież)",
                        run: function () {
                    ...
                    {
                        name: "Max Cards",
                        description: "Maksymalizuje wszystkie karty w twojej talii",
                        run: function () {
                            if (window.location.pathname == "/tower/map") {
                                const stateNode = getStateNode();
                    ...
                    {
                        name: "Max Health",
                        description: "Wypełnia zdrowie gracza",
                        run: function () {
                    ...
                    {
                        name: "Max Card Stats",
                        description: "Maksymalizuje obecną kartę gracza (Działa tylko na stronie wyboru atrybutów)",
                        run: function () {
                            const stateNode = getStateNode();
                    ...
                    },
                    {
                        ...
                        description: "Sprawia że statystyki karty przeciwnika wynoszą 0 (Działa tylko na stronie wyboru atrybutów)",
                        run: function () {
                            const stateNode = getStateNode();
                            if (stateNode.state.phase !== "select") alert("You must be on the attribute selection page.");
            ...
            kingdom: {
                ...
                cheats: [
                    {
                        name: "Choice ESP",
                        description: "Pokazuje co się stanie jeśli powiesz Tak lub Nie",
                        type: "toggle",
                        enabled: false,
                        data: null,
                        run: function () {
                    ...
                    {
                        name: "Max Stats",
                        description: "Ustawia wszystkie zasoby na maksimum",
                        run: function () {
                    ...
                    {
                        name: "Set Guests",
                        description: "Ustawia ilość gości których widziałeś",
                        inputs: [
                            {
                                name: "Guests",
                                type: "number",
                    ...
                    {
                        name: "Skip Guest",
                        description: "Pomija obecnego gościa",
                        run: function () {
            ...
            toy: {
                ...
                cheats: [
                    {
                        name: "Remove Distractions",
                        description: "Usuwa wszystkie rozproszenia przeciwników",
                        run: function () {
                    ...
                    {
                        name: "Send Distraction",
                        description: "Wysyła rozproszenie do wszystkich innych grających",
                        inputs: [
                            {
                                name: "Distraction",
                                type: "options",
                    ...
                    {
                        name: "Set Toys",
                        description: "Ustawia ilość zabawek",
                        inputs: [
                            {
                                name: "Toys",
                                type: "number",
                    ...
                    },
                    {
                        ...
                        description: "Ustawia ilość zabawek za pytanie",
                        inputs: [
                            {
                    ...
                    {
                        name: "Swap Toys",
                        description: "Zamienia zabawki z kimś",
                        inputs: [
                            {
                                name: "Player",
                                type: "options",
            ...
            flappy: {
                ...
                cheats: [
                    {
                        name: "Toggle Ghost",
                        description: "Pozwala przechodzić przez rury",
                        type: "toggle",
                        enabled: false,
                        run: function () {
    ...
    description: "Zmienia różne mechaniki gry i pozwala grać spacją",
    inputs: [
        {
            name: "Bird Gravity",
            type: "number",
    ...
    run: function(birdGravity, birdSpeed, birdFlapPower) {
        (function() {
            ...
            description: "Zastępuje starą grę nową treścią HTML",
            inputs: [{
                name: "HTML Code",
                type: "text"
            }],
            run: function(newHtml) {
                (function() {
                    ...
                    if (newHtml) {
                        ...
                        name: "Set Score",
                        description: "Ustawia wynik flappy blooka",
                        inputs: [
                            {
                                name: "Score",
                                type: "number",
        ...
        searchbarInput.placeholder = "Szukaj Cheatów";
        ...
        searchPage.onPath = searchbarHolder.onsubmit = (e) => {
            ...
            if (!hasResults) {
                noResult.innerText = `Nie znaleziono wyników dla "${query}"`;
        ...
        noFavorites.innerText = "Nie masz żadnych ulubionych.";
        ...
        const modeNameTranslations = {
            'Gold Quest': 'Poszukiwanie Złota',
            'Cafe': 'Kawiarnia',
            'Racing': 'Wyścigi',
            'Factory': 'Fabryka',
            'Tower Defense': 'Obrona Wieży',
            'Kingdom': 'Królestwo',
            'Fishing': 'Wędkarstwo',
            'Crazy Kingdom': 'Szalone Królestwo',
            'Brawl': 'Bitwa',
            'Hack': 'Hack',
            'Defense': 'Obrona',
            'Royale': 'Royale',
        ...
        for (const mode in cheats) {
            ...
            const translatedName = modeNameTranslations[cheats[mode].name] || cheats[mode].name;
            image.alt = name.innerText = translatedName;
            ...
            for (const cheat of cheats[mode].cheats) {
                ...
                if (cheat.type == "toggle") {
                    runButton.innerText = "Włącz";
                    runButton.classList.add(classes.toggleCheat);
                } else runButton.innerText = "Wykonaj";
                runButton.onclick = () => {
                    cheat.run.apply(
                        cheat,
                    ...
                    if (cheat.type == "toggle") {
                        runButton.innerText = cheat.enabled ? "Wyłącz" : "Włącz";
                        runButton.classList.toggle(classes.active, cheat.enabled);
                        Logs.addLog(`Przełączono "${cheat.name}" ${cheat.enabled ? "włączono" : "wyłączono"}`, cheat.enabled ? "var(--toggleOn)" : "var(--toggleOff)");
                    }
                    Logs.addLog(`Uruchomiono "${cheat.name}"`, "var(--highlight)");
                };
...
(function () {
    ...
    const MOBILE_KEY = "zclient_MOBILE_MODE_ENABLED";
    ...
    mobileCSS.innerHTML = `
        body.zclient-mobile-mode .Z-Client-sidebar {
        ...
        body.zclient-mobile-mode .Z-Client-sidebar span {
            display: none !important;
        }

        body.zclient-mobile-mode .Z-Client-sidebar::-webkit-scrollbar {
            display: none !important;
        }

        body.zclient-mobile-mode .Z-Client-content {
        ...
        body.zclient-mobile-mode .setting,
        body.zclient-mobile-mode .setting-row,
        body.zclient-mobile-mode .setting > *,
        body.zclient-mobile-mode .setting-row > * {
            min-width: 0 !important;
        ...
        .zclient-mobile-toggle-btn:hover {
            background: #00cc66;
    ...
    function enableMobile() {
        ...
        document.body.classList.add("zclient-mobile-mode");
        ...
        if (!exitBtn) {
            ...
            exitBtn.innerText = "Wyjdź z Trybu Mobilnego";
            exitBtn.className = "zclient-mobile-toggle-btn zclient-exit-btn";
    ...
    function disableMobile() {
        ...
        document.body.classList.remove("zclient-mobile-mode");
    ...
    if (!enterBtn) {
        ...
        enterBtn.innerText = "Włącz Tryb Mobilny";
        enterBtn.className = "zclient-mobile-toggle-btn";
    ...
    gui.toggleMobileMode = function () {
        ...
        aboutPage.className = classes.settingsPage;
        aboutPage.style.textAlign = "center";
        aboutPage.style.padding = "30px";
        
        const aboutTitle = document.createElement("h1");
        aboutTitle.innerText = "Z-Client";
        aboutTitle.style.color = "var(--highlight)";
        aboutTitle.style.fontSize = "3em";
        aboutTitle.style.textShadow = "0 0 20px var(--highlight)";
        aboutTitle.style.marginBottom = "10px";
        
        const aboutVersion = document.createElement("p");
        aboutVersion.innerText = "Wersja " + versionName;
        aboutVersion.style.fontSize = "1.2em";
        aboutVersion.style.marginBottom = "30px";
        aboutVersion.style.color = "var(--textColor2)";
        
        const aboutAuthor = document.createElement("div");
        aboutAuthor.style.marginBottom = "30px";
        aboutAuthor.innerHTML = `
            <p style="font-size: 1.5em; margin-bottom: 15px; color: var(--highlight);">Autor: Wojtoteka</p>
            <p style="margin: 10px 0;"><a href="https://wojtoteka.ovh/" target="_blank" style="color: var(--highlight); text-decoration: none; font-size: 1.2em;">🌐 wojtoteka.ovh</a></p>
            <p style="margin: 10px 0;"><a href="https://github.com/Wojtoteka" target="_blank" style="color: var(--highlight); text-decoration: none; font-size: 1.2em;">💻 github.com/Wojtoteka</a></p>
        `;
        
        const aboutDescription = document.createElement("p");
        aboutDescription.innerText = "Zaawansowany klient do Blooket z wieloma funkcjami i optymalizacją dla urządzeń mobilnych.";
        aboutDescription.style.fontSize = "1.1em";
        aboutDescription.style.lineHeight = "1.6";
        aboutDescription.style.marginTop = "30px";
        aboutDescription.style.padding = "20px";
        aboutDescription.style.background = "var(--background2)";
        aboutDescription.style.borderRadius = "12px";
        aboutDescription.style.border = "2px solid var(--highlight)";
        
        const aboutFeatures = document.createElement("div");
        aboutFeatures.style.marginTop = "30px";
        aboutFeatures.style.textAlign = "left";
        aboutFeatures.innerHTML = `
            <h2 style="color: var(--highlight); text-align: center; margin-bottom: 20px; font-size: 2em;">Funkcje</h2>
            <ul style="font-size: 1.1em; line-height: 2; list-style: none; padding: 0;">
                <li>✨ Nowoczesny interfejs z zieloną kolorystyką</li>
                <li>📱 Optymalizacja dla urządzeń mobilnych</li>
                <li>🎮 Wsparcie dla wszystkich trybów gry</li>
                <li>⚡ Szybkie i responsywne działanie</li>
                <li>🔧 Zaawansowane narzędzia i cheaty</li>
                <li>🌐 Polska lokalizacja</li>
            </ul>
        `;
        
        aboutPage.append(aboutTitle, aboutVersion, aboutAuthor, aboutDescription, aboutFeatures);
...
const ALT_KEY = "sclient_alts";
const getAlts = () => JSON.parse(localStorage.getItem(ALT_KEY) || "[]");
const setAlts = (alts) => localStorage.setItem(ALT_KEY, JSON.stringify(alts));
...
altPage.onPath = renderAlts;
        ...
        addSetting(
            "Theme",
            "Predefiniowany wygląd dla Z-Client",
            {
                type: "options",
                name: "Preset",
                options: [
...
},
{
    ...
    value: {
        ...
        addSetting("Highlight 2", "Secondary highlight color", { type: "string", name: "CSS Value", value: () => gui.style.getPropertyValue("--highlight2") }, (x) =>
        ...
        addSetting("Text Color 2", "Secondary text color", { type: "string", name: "CSS Value", value: () => gui.style.getPropertyValue("--textColor2") }, (x) =>
...
createSidebarPath("Szukaj", "search", searchPage);
createSidebarPath("Tryby Gry", "gamepad", gamemodesPage);
createSidebarPath("Ulubione", "star", favoritesPage);

(leaderboardPath = createSidebarPath("Ranking", "trophy", leaderboardPage)).style.display = "none";

createSidebarPath("Logi", "terminal", logsPage);
createSidebarPath("Ustawienia", "cog", settingsPage);
createSidebarPath("Tryb Mobilny", "mobile", mobilePage);
createSidebarPath("Menedżer Alt", "alt", altPage);
createSidebarPath("O Programie", "info-circle", aboutPage);
...
refreshControl.onclick = () => {
    ...
    path.updatePath();
        ...
        Logs.addLog("Aktywowano Z-Client");
        if (window.fetch.call.toString() == "function call() { [native code] }") {
            const call = window.fetch.call;
            window.fetch.call = function () {
                if (!arguments[1].includes("s.blooket.com/rc")) return call.apply(this, arguments);
    ...
    img.onload = function() {
        ...
        cts.drawImage(img, 0, 0, this.width, this.height);
        let { data } = cts.getImageData(0, 0, this.width, this.height), decode = "", last;
        let i = 0;
        while (i < data.length) {
